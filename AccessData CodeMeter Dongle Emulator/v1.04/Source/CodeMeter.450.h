 ...
 * (C) Copyright 2002-2012 by WIBU-SYSTEMS AG
 * D-76137 Karlsruhe, Germany
 * Version 4.50 of 2012Mar21
 * ---------------------------------------------------------------------------
 */
...
#define CM_BE_PIO_MASK                0x0003ffff
...
typedef struct __CMBOXENTRY2 {
  ...
  CMULONG mulFirmPreciseTime;
  CMUSHORT mausFirmItemText[CM_MAX_STRING_LEN];
  CMBYTE mabReserve1[108]; /* aligned to 640 */
  /* flag specified the set ProductItem Option */
  CMULONG mflSetPios;
  /* Product Item data */
  CMULONG mulProductCode;
  ...
  CMBYTE mabReserve2[48]; /* aligned to 796 */
  CMBYTE mfbDependencyPC;
  CMBYTE mfbDependencyFM;
  ...
  CMBYTE mabReserve3[15]; /* aligned to 820 */
  CMUSHORT musProductItemRef;
  CMBYTE mabReserve4[202]; /* aligned to 1024 */
} CMBOXENTRY2;
...
#define CM_SYSTEM_W2008R2             0x00000010
#define CM_SYSTEM_W8                  0x00000011
#define CM_SYSTEM_W2012               0x00000012
...
typedef struct __CM_DISC_CONFIGURATION {
  ...
  CMULONG mulArticleMajor;
  CMULONG mulArticleMinor;
  CMULONG mulArticleSubcase;
...
// this typedef is the obsolete former preliminary struct-name which has to be
// maintained for one Customer. Please use CMENABLING_CONTEXT.
typedef CMENABLING_CONTEXT CM_ENABLE_CONTEXT;
...
#define CM_ACTSTATUS_BLACKLISTED       0x00100000 
  ...
  /* CM_ACTSTATUS_VM_DETECTED has two meanings: When returned by
     ...
     was permitted) */
#define CM_BOXSTATUS_CMACT_MASK        0x0F10FF00
