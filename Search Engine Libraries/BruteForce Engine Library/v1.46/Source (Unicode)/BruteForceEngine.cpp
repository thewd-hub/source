...
{
	ZeroMemory(BruteForceEngine_IndexCounters, BRUTEFORCEENGINE_MAX_WORD_LENGTH * 2);
	ZeroMemory(BruteForceEngine_CurrentWord, BRUTEFORCEENGINE_MAX_WORD_LENGTH * 2);
	...
	for (int i = 0; i < BruteForceEngine_CurrentWordLength * 2; i += 2) BruteForceEngine_CurrentWord[i] = BruteForceEngine_FirstCharacter;
}
...
{
	return (((double)BruteForceEngine_IndexCounters[((BruteForceEngine_CurrentWordLength * 2) - 2)] / (double)BruteForceEngine_ActualCharSetLength) * 100);
}
